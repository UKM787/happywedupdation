    ...
    <div class="login-main-cont">
        <div class="login-left-cont">
            <div class="login-form-cont">
                <h1>Welcome to happywed Guest Page!</h1>
                <p> As a guest, you can log in to your account to view your wedding invitation, RSVP, and provide your family member's details, as well as your arrival and departure details. Log in now to ensure your attendance is counted and you don't miss out on any important wedding details.</p>          
                <form
                    @submit.prevent
...
export default {
    ...
    methods: {
        ...
        loginUser(e) {
            ...
            let formData = new FormData();
            let link = route("login");
            if (this.active == "admin") {
                link = route("loginAdmin");
            }
