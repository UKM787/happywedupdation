...
@section('content')
<landing-privacy-policy></landing-privacy-policy>
{{-- <!-- <div class="container">
    <h3> Privacy Policy </h3>
    <p>
        Our management has created this Privacy Statement (Policy) in order to establish our firm commitment to help our users better understand what information we collect about them and what may happen to that information.
        The terms "We, Happy Wedding, Us" refer to www.happywed.in and the terms "You, Your" refer to a user of Happywed.com.
        In the course of our business of helping our viewers plan their wedding, we collect certain information from you.
        In the course of registering for and availing various services we provide from time to time through our website: Happy Wedding, you may be required to give your Name, address, Email address, phone number.
    ...
    <p>
        We have affiliate links to many other online resources. We are not responsible for the practices employed by these affiliates or their websites linked to or from Happywed.com nor the information or content contained on these third party websites. You should carefully review their privacy statements and other conditions of use and you agree you provide information or engage in transactions with these affiliates at your own risk.
    </p>
    ...
    <p>
        Happywed.com features some of the latest trends in Indian weddings around the world, and tries to give its users exposure to quality hand-picked content. In our endeavor, we feature pictures and stories from various real weddings and vendors. Vendors are expected to take utmost care to take permission / hold copyright of images given to us. We also feature weddings and articles where users have given us permission to use the same.
        However, in the unlikely event of anyone having any objection to content put up on our site, they are free to contact us immediately and we will be happy to consider their request and take necessary action
    </p>
    <h3> Updates on Privacy Policy</h3>
    <p> We reserve the right to revise these Privacy Policies of Happy Wedding.com from time to time by updating this posting. Such revised policies will take effect as of the date of posting</p>

    <h3> Contact Us </h3>
    <p> If you have any further queries regarding the privacy policy, feel free to contact us at XXXXXXXXX
    </p>
