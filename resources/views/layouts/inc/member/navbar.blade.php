                    ...
                    <ul>
                        ...
                        <li>
                            <a href="#" title="Profile">
                                @if(! true))
                                <span class="h-icon"><img src="{{asset('storage').$host->profile->imageOne}}" alt="avtar" style="width:28px ;height:28px"></span>
                                @else
                        ...
                        <li>
                            ...
                            <form id="logout-form" action="{{ route('logoutMember') }}" method="POST" class="d-none">
                                @csrf
                            </form>
                        </li>
                        @endunless
        ...
        <div class="splide__track">
            <ul class="splide__list text-center wed-host-main-nav-items">
                <li class="splide__slide">
                    <a href="{{route('memberwelcome', $member)}}">Welcome</a>
                </li>
                <li class="splide__slide">
                    <a href="#">{{__('Work Details')}}</a>
                </li>
                <li class="splide__slide">
                    <a href="#">{{__('To-Do List')}}</a>
                </li>
                <li class="splide__slide">
                    <a href="#">{{__('Shortlisted')}}</a>
                </li>
                <li class="splide__slide">
                    <a href="#">{{__('Saved Posts')}}</a>
                </li>
            </ul>
        </div>
    </div>
