            ...
            <div class="col-8" style="display:flex; justify-content:end;">
                <div class="profile" style="align-self: center; padding-top:0;">
                    <ul>
                        ...
                        <li>
                            <a href="{{route('vendorLogin')}}" title="VendorSign In"> <span class="h-icon"><i class="fa fa-sign-in" aria-hidden="true" title="vendorlogin"></i></span>
                            </a>
                        </li>

                        @else
                        <li>
                            <a href="{{route('vendorprofile.index', $vendor)}}" title="Profile">
                                @if($vendor->profile != null)
                                <span class="h-icon"><img src="{{asset('assets/vendors/uploads/').'/'.$vendor->profile->avatar}}" alt="avtar" style="width:28px ;height:28px"></span>
                                @else
                        ...
                        <li>
                            ...
                            <form id="logout-form" action="{{ route('logoutVendor') }}" method="POST" class="d-none">
                                @csrf
                            </form>
                        </li>
                        @endunless
        ...
        <div class="splide__track">
            <ul class="splide__list text-center wed-host-main-nav-items">
                <li class="splide__slide">
                    <a href="{{route('vendorwelcome')}}">Welcome</a>
                </li>
                <!-- <li class="splide__slide">
                    <a href="{{route('vendorcategory.index', $vendor)}}"><i class="fa fa-paperclip me-2"></i>{{__('Category')}}</a>
                </li>
                <li class="splide__slide">
                    <a href="{{route('vendorservices.index', $vendor)}}"><i class="fa fa-paperclip me-2"></i>{{__('Services')}}</a> -->
                </li>
                <li class="splide__slide">
                    <a href="{{route('vendorservicesnew.index', $vendor)}}"><i class="fa fa-paperclip me-2"></i>{{__('Services')}}</a>
                </li>

                <!-- <li class="splide__slide">
                    <a href="{{route('vendorservicesmultiple.index', $vendor)}}"><i class="fa fa-paperclip me-2"></i>{{__('ServicesMultiple')}}</a>
                </li> -->
                <li class="splide__slide">
                    <a href="{{route('vendorleads.index', $vendor)}}"><i class="fa fa-gift me-2"></i>{{__('Leads')}}</a>
                </li>
                <li class="splide__slide">
                    <a href="{{route('vendorcalendar.index', $vendor)}}"><i class="fa fa-gift me-2"></i>Calendar</a>
                </li>
                <li class="splide__slide">
                    <a href="{{route('vendorprojects.index', $vendor)}}"><i class="fa fa-gift me-2"></i>Projects</a>
                </li>
                <li class="splide__slide">
                    <a href="{{route('vendorreviews.index', $vendor)}}"><i class="fa fa-gift me-2"></i>{{__('Reviews')}}</a>
                </li>
                <!-- <li class="splide__slide">
