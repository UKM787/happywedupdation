          ...
          <div class="row">
            <div class="col-sm-12">
              <label class="checkbox" for="pickup">
                ...
                {{$itinerary->pickup ? 'Pickup' : 'No Pickup'}}
              </label>
            </div>
          </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <label for="location" class="col-sm-2 col-form-label text-md-right">{{ __('Location') }}</label>
