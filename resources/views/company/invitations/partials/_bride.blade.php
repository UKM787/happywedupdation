<div class="row justify-content-center mb-3">
  <div class="col-md-12">
    <div class="card">
      <div class="card-header text-white text-center h4 bg-nav">{{ucwords($host->name)}} {{ __(' Add Bride') }} <a href="" class="btn btn-sm"><span class="px-3 text-danger">skip</span></a></div>
