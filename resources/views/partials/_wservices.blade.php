...
<div class="row">
    ...
    <div class="col-md-12">
        <label class="form-label" id="name">{{ucwords($service) }} Name*</label>
...
<div class="row">
    <div class="col-md-12">
        <label class="form-label" id="description">{{ucwords($service)}} Description*</label>
...
<div class="row">
    <div class="col-md-12">
        <label class="form-label" id="address">{{ucwords($service)}} Address*</label>
...
<div class="row">
    ...
    <div class="col">
        <label for="category_id" class="form-label">{{ucwords($service)}} Category*</label>
    ...
    @endif
    <div class="col">
        <label for="location_id" class="form-label">{{ucwords($service)}} Location*</label>
...
<div class="row">
    <div class="col-md-4">
        ...
        <input type="text" name="icon" id="icon" class="form-control  @error('icon') is-invalid @enderror" value="{{ old('icon') ?? $accommodation->icon ?? '' }}" autocomplete="icon">
        @error('icon')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
...
<div class="row mt-3">
    <div class="col-md-2">
        <div class="upload-cover">
            ...
            <img src="{{asset('assets/accommodations\/').$accommodation->imageOne}}" alt="VendorService Photo" id="imageOneTag" width="125px" height="auto">

            @else
            <img src="{{asset('assets/accommodations\/').'hotelDefault.png'}}" alt="VendorService Photo" id="imageOneTag" width="125px" height="auto">
            @endif
