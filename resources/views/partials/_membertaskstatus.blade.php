<!-- member taskCompletion Status -->
<h1>Member taskcomletion status to be displayed here</h1>
...
<div class="row wed-form-row">
    ...
    <div class="input-group col-sm-3 mb-3">
        <div class="input-group-prepend">
            <span class="input-group-text mr-2" id="mobile1">{{ __('Primary Mobile')}}</span>
        </div>
        <input name="mobile1" type="text" class="form-control @error('mobile1') is-invalid @enderror" placeholder="Mobile No." value="{{ old('mobile1') ?? $profile->mobile1 ?? ''}}" aria-label="mobile1" aria-describedby="mobile1" autocomplete="mobile1" {{$wedform}}>
        @error('mobile1')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
    ...
    <div class="input-group col-sm-3 mb-3">
        <div class="input-group-prepend">
            <span class="input-group-text mr-2" id="mobile2">{{ __('Alternate Mobile') }}</span>
        </div>
        <input name="mobile2" type="text" class="form-control @error('mobile2') is-invalid @enderror" placeholder="Alternate Mobile No." value="{{ old('mobile2') ?? $profile->mobile2 ?? ''}}" aria-label="mobile2" aria-describedby="mobile2" autocomplete="mobile2" {{$wedform}}>
