...
<div class="row mt-3">
    <div class="col-md-2">
        <div class="upload-cover">
            ...
            <img src="{{asset('assets/accommodations\/').$accommodation->imageOne}}" alt="profilePhoto" id="imageOneTag" width="125px" height="auto">

            @else
            <img src="{{asset('assets/accommodations\/').'hotelDefault.png'}}" alt="accommodationPhoto" id="imageOneTag" width="125px" height="auto">
            @endif
