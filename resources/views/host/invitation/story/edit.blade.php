...
<div class="wed-host-section">
    <div class="wed-host-section-container">
        ...
        <div class="wed-host-section-container-form">
            <form method="POST" action="{{route('hoststory.update',[$invitation, $story])}}" enctype="multipart/form-data" name="storyForm">
                @include('host.partials._story', ['submitBtn' => 'Update', 'wedform' => ''])
                @csrf
                @method('PATCH')
            </form>
        </div>
