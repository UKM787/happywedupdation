...
class CategoryMasterImport implements ToModel, WithHeadingRow,SkipsEmptyRows, SkipsOnError,WithBatchInserts, SkipsOnFailure
{
    ...
    public function model(array $row)
    {
        try{
            if(isset($row['name']))
            {
                ...
                //dd(empty($row['parent_id']), $row);
                
                $category = new  VendorMaster([
                    'name'          => $row['name'] ?? " ", 
                    ...
                    'relation'      => empty($row['relation']) ? null : $row['relation'],
                    'path'          => empty($row['path']) ? null : $row['path'],
